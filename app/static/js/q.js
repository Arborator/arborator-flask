...
settings = function() 
	{
		...
		attris = {"t":		{"font": '18px Arial', "text-anchor":'start',"fill": '#000',"cursor":'move',"stroke-width": '0'}, 
			...
			"source":	{"fill": '#654b6d'},
			"target":	{"fill": '#dd137b',"cursor": 'url("static/images/connect.png"),pointer', "font-style":'italic'}, 
...
// 	console.log(232,treelines)
	$.each(treelines, function(i,treeline){ // splits the conll txt into tree segments:
		...
		gt += '<div class="cut" title="cut after selected word." id="cut'+i+'"><img src="static/images/cut.png"/></div>'
		$("#trees").append('<div id="sentencediv'+treenr+'" class="sentencediv" nr="'+treenr+'"> <a id="toggler'+treenr+'" class="toggler expanded" nr="'+treenr+'"> '+treenr+': '+sentence+' </a>		<img id="undo'+treenr+'" class="undoimg"	src="static/images/undo.png">				<img id="redo'+treenr+'" class="redoimg"	src="static/images/redo.png"> <img id="export'+treenr+'" class="exportimg" border="0" title="export the dependency graph in various image formats" nr="'+treenr+'" src="static/images/export.png" style="visibility: visible;"> </div> <div id="holder'+treenr+'" class="svgholder"	nr="'+treenr+'">'+gt+'</div>')
		
		treenr++;
	});
	conllarea.css("backgroundImage","url('static/images/conll"+el+".png')");	
...
// 			$( '<xspan class="annodoc"><img id="export'+i+'" class="exportannodoc" border="0" style="visibility: visible;" src="static/images/export.bw.png" nr="'+i+'" title="export the Annodoc svg graph"></xspan>').insertAfter( '#export'+i );
